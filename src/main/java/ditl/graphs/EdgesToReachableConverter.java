...
public class EdgesToReachableConverter implements EdgeTrace.Handler, Generator, Converter {
    ...
    private final Bus<Edge> edge_bus = new Bus<Edge>();
    private final Bus<ArcEvent> outbus = new Bus<ArcEvent>();
    private final Set<Edge> cur_edges = new AdjacencySet.Edges();
    ...
    public void convert() throws IOException {
        ...
        if (_delay >= _tau) {
            ...
            final Runner runner = new Runner(_tau, _edges.minTime(), _edges.maxTime() + 1);
    ...
    private final class Outputer implements Listener<ArcEvent> {
        ...
        public void handle(long time, Collection<ArcEvent> events)
            ...
            final Deque<ArcEvent> down_events = new LinkedList<ArcEvent>();
